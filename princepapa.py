...
bot = telebot.TeleBot('7385829499:AAHQY65Q-SfD79i0I4-22-TEbHVgn4PXzfs')
# Owner and admin user IDs
owner_id = "1392100031"
admin_ids = ["1344698412", "ADMIN_ID2"]
...
def handle_attack(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /attack command. "
                    ...
                    "🌟THE ONLY OWNER IS @REAL_STARK DM TO BUY ACCESS")
